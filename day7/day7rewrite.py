...
def fiveOfAKindFinder(hand: str):
    ...
    return handCont.most_common(1)[0][1] == 5


def fourOfAKindFinder(hand: str):
    assert len(hand) == 5
    handCont = Counter(hand)
    return handCont.most_common(1)[0][1] == 4
...
def fullHouseFinder(hand: str):
    ...
    return mostComm[0][1] == 3 and mostComm[1][1] == 2
...
def twoPairFinder(hand: str):
    ...
    handCont = Counter(hand)
    mostComm = handCont.most_common()
    return mostComm[0][1] == 2 and mostComm[1][1] == 2
...
def compareHands(hand1:str,hand2:str):
    ...
    cardStrengthOrder = ['A','K','Q','J','T','9','8','7','6','5','4','3','2']
